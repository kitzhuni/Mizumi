...
<div class="container">
    <div class="restaurant-info">
        ...
        <div class="owl-carousel owl-theme">
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Roma.png') }}" alt="Roma"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Roma1.png') }}" alt="Roma1"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Roma2.png') }}" alt="Roma2"></div>
  ...
  <a href="storage/Fotos Hoteles/Centro-Consumo.jpg" target="_blank">
    ...
    <div class="recomendaciones">
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Aroma Bebida 1.jpg') }}" alt="Entradas" onclick="toggleInfo(this)">
            <h3>GAMBAS</h3>
            <div class="info">Envueltas en fideos crujientes y aderezo de mostaza dulce.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Aroma Platillo 1.JPG') }}"  alt="Dumplings" onclick="toggleInfo(this)">
            <h3>SATAY DE POLLO Y CAMARONES</h3>
            <div class="info">Brochetas de pollo y gambas a la plancha con salsa de cacahuete.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Aroma Platillo 2.JPG') }}" alt="Sopas" onclick="toggleInfo(this)">
            <h3>SOPA DE MISO SHIRO</h3>
            <div class="info">Sopa tradicional japonesa con miso de soja y pasta.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Aroma Postre 1.JPG') }}" alt="Ramen" onclick="toggleInfo(this)">
