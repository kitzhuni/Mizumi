...
<head>
    ...
    <title>Scala Ocean - Restaurante Japonés</title>
...
<div class="container">
    <div class="restaurant-info">
        ...
        <p>Nuestro objetivo es ofrecerle una experiencia completa, donde cada detalle ha sido meticulosamente cuidado para su máximo disfrute. Comience su experiencia gastronómica con una amplia variedad de deliciosos platos, que van desde opciones de marisco fresco y sabroso hasta platos tradicionales y creativas fusiones culinarias. Nuestro talentoso equipo de chefs se esfuerza por ofrecerle sabores auténticos y platos que satisfagan todos los paladares.</p>
    </div>
    

        <div class="owl-carousel owl-theme">
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Scala1.png') }}" alt="Imagen 1"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Scala2.png') }}"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Scala3.png') }}"></div>
  ...
  <a href="storage/Fotos Hoteles/Centro-Consumo.jpg" target="_blank">
    ...
    <div class="recomendaciones">
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Scala Bebida 1.JPG') }}" alt="Entradas" onclick="toggleInfo(this)">
            <h3>GAMBAS</h3>
            <div class="info">Envueltas en fideos crujientes y aderezo de mostaza dulce.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Scala Bebida 2.JPG') }}"  alt="Dumplings" onclick="toggleInfo(this)">
            <h3>SATAY DE POLLO Y CAMARONES</h3>
            <div class="info">Brochetas de pollo y gambas a la plancha con salsa de cacahuete.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Scala Platillo1.JPG') }}" alt="Sopas" onclick="toggleInfo(this)">
            <h3>SOPA DE MISO SHIRO</h3>
            <div class="info">Sopa tradicional japonesa con miso de soja y pasta.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Scala Platillo 2.JPG') }}" alt="Ramen" onclick="toggleInfo(this)">
            <h3>RAMEN DE TERNERA</h3>
            <div class="info">Acelgas chinas con ternera, col, setas, huevo cocido y zanahoria.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Scala Postre 1.JPG') }}" alt="Dice" onclick="toggleInfo(this)">
