...
<head>
    ...
    <title>Carnivore - Restaurante</title>
...
<div class="container">
    <div class="restaurant-info">
        <h2 class="title">Carnivore</h2>
        <div class="yellow-line"></div>
        <p>Nuestro menú se compone de exquisitos platos que le harán la boca agua. Desde los favoritos de la casa, como jugosos filetes perfectamente cocinados, hasta entrantes ligeros y ensaladas frescas, en Carnivore encontrará una amplia selección de opciones para satisfacer todos los paladares.</p>
        <p> Nos enorgullecemos de ofrecer los mejores y más jugosos cortes de carne, cuidadosamente seleccionados para garantizar la máxima calidad y sabor. Cada bocado es una experiencia única, llena de sabores intensos y texturas suculentas que le transportarán al paraíso de la carne.</p>
    </div>

    

        <div class="owl-carousel owl-theme">
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Carnivore.png') }}" alt="Imagen 1"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Carnivore1.png') }}"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Carnivore2.png') }}"></div>
  ...
  <a href="storage/Fotos Hoteles/Centro-Consumo.jpg" target="_blank">
    ...
    <div class="recomendaciones">
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/CarnivoreBebida1.jpg') }}" alt="Entradas" onclick="toggleInfo(this)">
            <h3>Bebida</h3>
            <div class="info">Envueltas en fideos crujientes y aderezo de mostaza dulce.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/CarnivoreBebida 2.jpg') }}"  alt="Dumplings" onclick="toggleInfo(this)">
            <h3>SATAY DE POLLO Y CAMARONES</h3>
            <div class="info">Brochetas de pollo y gambas a la plancha con salsa de cacahuete.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Carnivore Platillo 1.JPG') }}" alt="Sopas" onclick="toggleInfo(this)">
            <h3>SOPA DE MISO SHIRO</h3>
            <div class="info">Sopa tradicional japonesa con miso de soja y pasta.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Carnivore Platillo 2.JPG') }}" alt="Ramen" onclick="toggleInfo(this)">
            <h3>RAMEN DE TERNERA</h3>
            <div class="info">Acelgas chinas con ternera, col, setas, huevo cocido y zanahoria.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Carnivore POSTRE 1.JPG') }}" alt="Dice" onclick="toggleInfo(this)">
