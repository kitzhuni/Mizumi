...
<head>
    ...
    <title>Marche - Restaurante</title>
...
<div class="container">
    <div class="restaurant-info">
        ...
        <div class="owl-carousel owl-theme">
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Marche.png') }}" alt="Marche"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Marche1.png') }}" alt="Marche1"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Marche2.png') }}" alt="Marche2"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Marche3.png') }}" alt="Marche3"></div>
  ...
  <a href="storage/Fotos Hoteles/Centro-Consumo.jpg" target="_blank">
    ...
    <div class="recomendaciones">
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Marche Bebida 1.JPG') }}" alt="Entradas" onclick="toggleInfo(this)">
            <h3>GAMBAS</h3>
            <div class="info">Envueltas en fideos crujientes y aderezo de mostaza dulce.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Marche Platillo 1.JPG') }}"  alt="Dumplings" onclick="toggleInfo(this)">
            <h3>SATAY DE POLLO Y CAMARONES</h3>
            <div class="info">Brochetas de pollo y gambas a la plancha con salsa de cacahuete.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Marche Platillo 2.JPG') }}" alt="Sopas" onclick="toggleInfo(this)">
            <h3>SOPA DE MISO SHIRO</h3>
            <div class="info">Sopa tradicional japonesa con miso de soja y pasta.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Marche Postre 1.JPG') }}" alt="Ramen" onclick="toggleInfo(this)">
