...
<div class="container">
    <div class="restaurant-info">
        <h2 class="title">Acua</h2>
        <div class="yellow-line"></div>
        <p>Déjese seducir por suntuosos bocadillos que le transportarán a un mundo de exquisitos sabores. Nuestras refrescantes ensaladas le proporcionarán una explosión de frescura y vitalidad, mientras que nuestros sabrosos bocadillos satisfarán hasta el paladar más exigente.

No puedes perderte nuestra tradicional sopa de pozole, un plato que te llevará directo a las raíces de la cocina mexicana, con su perfecta combinación de ingredientes y sabores auténticos. Y para los que buscan una experiencia realmente memorable, nuestra famosa hamburguesa Las Olas te sorprenderá por su jugosidad y delicioso sabor.</p>
    </div>
    

        <div class="owl-carousel owl-theme">
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Acua1.png') }}" alt="Imagen 1"></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Acua2.png') }}" ></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Acua3.png') }}" ></div>
            <div class="item"><img src="{{ asset('storage/Fotos Hoteles/Acua4.png') }}"  alt="Imagen 4"></div>
  ...
  <a href="storage/Fotos Hoteles/Centro-Consumo.jpg" target="_blank">
    ...
    <div class="recomendaciones">
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/ACUA.jpg') }}" alt="Entradas" onclick="toggleInfo(this)">
            <h3>GAMBAS</h3>
            <div class="info">Envueltas en fideos crujientes y aderezo de mostaza dulce.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Acua Platillo 1.jpg') }}"  alt="Dumplings" onclick="toggleInfo(this)">
            <h3>SATAY DE POLLO Y CAMARONES</h3>
            <div class="info">Brochetas de pollo y gambas a la plancha con salsa de cacahuete.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Acua Platillo 2.jpg') }}" alt="Sopas" onclick="toggleInfo(this)">
            <h3>SOPA DE MISO SHIRO</h3>
            <div class="info">Sopa tradicional japonesa con miso de soja y pasta.</div>
        </div>
        <div>
            <img src="{{ asset('storage/Fotos Hoteles/Acua Platillo 3.jpg') }}" alt="Ramen" onclick="toggleInfo(this)">
