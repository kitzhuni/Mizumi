...
<head>
    ...
    <title>Restaurantes Princess Mundo Imperial</title>
...
>
    ...
    <div class="container">
        ...
        <p>El Princess Mundo Imperial en Acapulco es un complejo turístico de lujo con una variedad de restaurantes de alta gama que ofrecen opciones culinarias para todos los gustos en un entorno lujoso, convirtiendo cada bocado en una experiencia placentera.</p>
        <div class="restaurants">
            <div class="restaurant">
    
                <img src="{{ asset('storage/Fotos Hoteles/Chulavista.png') }}" alt="Chulavista">
                <div class="restaurant-info">
                    <h3>Chula Vista</h3>
                    <p>Chula Vista es un buffet matutino al aire libre que combina lo mejor de la cocina mexicana tradicional con opciones variadas como barra de cereales, yogur, hot cakes, panes, mermeladas, y platos preparados al momento </p>
                    <p><strong>LUN - DOM: 07:00 am - 12:00 pm</strong></p>
                    <p><strong>* No se require reservación.</strong></p>
                    <a href="{{ url('/chulamundoimperial') }}" class="button">Visitar Restaurante</a>
                </div>
            </div>
            ...
            <div class="restaurant">
                ...
                <div class="restaurant-info">
                    ...
                    <p><strong>* No se require reservación.</strong></p>
                    <a href="{{ url('/condesamundoimperial') }}" class="button">Visitar Restaurante</a>
                </div>
            </div>
            ...
            <div class="restaurant">
                ...
                <div class="restaurant-info">
                    ...
                    <p><strong>LUN - DOM: 10:00 am - 08:00 pm</strong></p>
                    <p><strong>* No se require reservación.</strong></p>
                    <a href="{{ url('/tavolamundoimperial') }}" class="button">Visitar Restaurante</a>
                </div>
            </div>
            ...
            <div class="restaurant">
                ...
                <div class="restaurant-info">
                <h3>Azul</h3>
                    <p>Déjese llevar por la vibrante música en directo mientras le sorprendemos con nuestra vanguardista mixología. En nuestro exclusivo bar, le invitamos a descubrir una lista de ginebras cuidadosamente seleccionadas que le deleitarán</p>
                    <p><strong>LUN - DOM: 10:00 am - 08:00 pm</strong></p>
                    <p><strong>* No se require reservación.</strong></p>
                    <a href="{{ url('/azulmundoimperial') }}" class="button">Visitar Restaurante</a>
                </div>
            </div>

            <div class="restaurant">
            <img src="{{ asset('storage/Fotos Hoteles/clubbeach.png') }}" alt="ClubBeach">
                <div class="restaurant-info">
                <h3>The Beach Club</h3>
                    <p>Al aire libre y situado entre dos piscinas con impresionantes vistas del Océano Pacífico. </p>
                    <p><strong>LUN - DOM: 12:00 am - 06:00 pm</strong></p>
                    <p><strong>* No se require reservación.</strong></p>
                    <a href="{{ url('/beachmundoimperial') }}" class="button">Visitar Restaurante</a>
                </div>
            </div>
            ...
            <div class="restaurant">
                <img src="{{ asset('storage/Fotos Hoteles/Pool Bar.jpg') }}" alt="Serenity">
                <div class="restaurant-info">
                    <h3>Café et Chocolat</h3>
                    <p>Sumérjase en una experiencia de relajación absoluta mientras saborea un cóctel hecho a su medida. Disfrute de nuestro exclusivo bar situado en una piscina, donde podrá deleitar deliciosas bebidas en un ambiente familiar y excelente música.</p>
                    <p><strong>LUN - DOM: 10:00 am - 08:00 pm</strong></p>
                    <p><strong>* No se require reservación.</strong></p>
                    <a href="{{ url('/cafemundoimperial') }}" class="button">Visitar Restaurante</a>
                </div>
            </div>
